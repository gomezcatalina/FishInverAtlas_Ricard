...
vars <- c("CLASS_","ORDER_","FAMILY_","ACCEPTED_SCIENT_NAME","FAO_E_COMMON_NAME","FAO_F_COMMON_NAME","spec","nrecords","type")
knitr::kable(spec.tab[,vars], "latex", booktabs = TRUE, longtable = TRUE, align = "c", col.names = c("Class","Order","Family","Scientific name","English name","French name","Species code","Num. records","Ticket class"), caption = "(ref:spec-fig-cap)") %>%
