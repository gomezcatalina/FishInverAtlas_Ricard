...
The survey follows a stratified random design [@DoubledayRivard1981; @Lohr1999]. The number of tows conducted in each stratum is approximately proportional to its surface area.
...
#  kableExtra::column_spec(5, italic=T, width="3cm") %>% 
#  kableExtra::column_spec(6, italic=T, width="3cm") %>% 
...
All data processing and analyses were conducted using the R software [@R:2013] using packages RODBC [@R:package:RODBC], PBSmapping [@R:package:PBSmapping], spatstat [@R:package:spatstat], gstat [@R:package:gstat), maptools [@R:package:maptools], rgeos [@R:package:rgeos], xtable [@R:package:xtable], MASS [@R:package:MASS] and [@R:Tidyverse]. 
